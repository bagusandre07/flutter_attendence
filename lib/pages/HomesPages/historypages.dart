...
class _HistoryPagesState extends State<HistoryPages> {
  ...
  fetchUser() async {
    ...
    String url = "https://sinfokit.cleverapps.io/doctor/all";
  ...
  Widget getCard(item) {
    var fullName = item['nama'];
    item['nama'];
    var email = item['category'];
    var profileUrl = item['poto'];
    var linkchat = item['directchat'];
    return Card(
      elevation: 1.5,
      child: Padding(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: NetworkImage(
                            'https://sinfokit.cleverapps.io/uploads/$profileUrl'))),
              ),
              SizedBox(
                width: 20,
              ),
